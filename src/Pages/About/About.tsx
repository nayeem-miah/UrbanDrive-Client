...
const AboutUs: React.FC = () => {
  ...
  return (
    <div className="about-us">
      <>
        <div
          className="background-container flex items-center justify-center overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="text-center content  flex flex-col px-4">
            ...
            <p className="text-white mt-4 sm:mt-8 text-sm sm:text-lg font-Merri font-bold w-full sm:w-3/4 mx-auto">
              Our mission is to be the leading car rental provider, delivering
              exceptional service, prioritizing safety, and offering
              unparalleled convenience to our customers, making every journey a
              memorable one.
            </p>
      ...
      <section className="py-12 sm:py-16 px-4 md:px-16">
        <div className="container mx-auto">
          ...
          <p className="mt-4 sm:mt-6 text-center max-w-3xl mx-auto text-base sm:text-lg text-gray-500 font-Merri">
            To become the leading car rental company known for quality,
            innovation, and commitment to our customers and community.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="container mx-auto content">
          ...
          <p className="mt-4 sm:mt-6 text-center max-w-3xl mx-auto text-base sm:text-lg text-white font-Merri">
            ...
            expectations, ensuring convenience, reliability, and satisfaction in
            every journey.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="container mx-auto content">
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl mx-auto text-base sm:text-lg text-center text-white font-Merri">
            Founded in 2024, UrbanDrive has quickly grown to become a trusted
            name in car rentals, known for our dedication to customer service
            ...
            {["Integrity", "Trust", "Honesty"].map((value) => (
              ...
              >
                ...
                <p className="mt-2 sm:mt-4 text-gray-500 font-Open">
                  We act with {value.toLowerCase()} in all that we do.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 sm:py-16 px-4 md:px-16">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-4 sm:mt-6 max-w-3xl mx-auto text-base sm:text-lg text-gray-500">
            ...
            <a
              href="mailto:info@urbandrive.com"
