            ...
            <div className="flex-1">
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-600">
                  Family road trip or backcountry adventure? Experience it in a
                  Subaru rental. Rev up your taste for adventure and make your
                  mark regardless of the weather conditions. Flexible
                  configurations, seamless connectivity, award-winning safety,
                  and comfortable handling are just the beginning. Rent one for
                  an extended test drive, and see why Turo guests can’t get
                  enough of all that Subaru love.
                </p>
              </div>
